  ...
  return (
    <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
          ...
          isSearched && (searchFilter.title !== "" || searchFilter.location !== "") && (
            <>
              ...
              <div className='mb-4 text-gray-600'>
                {searchFilter.title && (
                  <span className='inline-flex item-center gap-2.5 bg-blue-50 border-blue-200 px-4 py-1.5 rounded'>
                    {searchFilter.title}
                    <img onClick={e => setSearchFilter(prev => ({ ...prev, title: "" }))} className='cursor-pointer' src={assets.cross_icon} alt="" />
                  </span>
                )}
                {searchFilter.location && (
                  <span className='ml-2 inline-flex item-center gap-2.5 bg-red-50 border-red-200 px-4 py-1.5 rounded'>
                    {searchFilter.location}
      ...
      <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
        <h3 className='font-medium text-3xl py-2' id='job-list'>Lstest Jobs</h3>
