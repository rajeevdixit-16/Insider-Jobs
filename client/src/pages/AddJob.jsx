  ...
  return (
    <form className='container p-4 flex flex-col w-full itmes-start gap-3'>
      ...
      <div className='w-full'>
        ...
        onChange={e=>setTitle(e.target.value)} value={title} required className='w-full max-w-lg px-3 py-2 border-2 border-gray-300 rounded'/>
      </div>
      ...
      <button className='w-28 py-3 mt-4 bg-black text-white rounded-4xl cursor-pointer'>ADD</button>
    </form>
  )
}
